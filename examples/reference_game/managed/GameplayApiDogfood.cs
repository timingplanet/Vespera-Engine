...
// 0.6.3 dogfood component for the gameplay-foundation completion bundle. It
// intentionally uses only public Vespera.NET surfaces so the reference game
// stays representative of what an external C# project can do.
public sealed class GameplayApiDogfood : Component
{
    ...
    public override void Start()
    {
        ...
        if (uiTitle is not null)
        {
            ...
            {
                // 0.9.9c dogfood: this string-valued semantic call travels through
                // UiSurface even though the reference HUD is still legacy .slui.
